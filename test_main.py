...
# Check file using Spark (uncomment if running in Databricks environment)
# if check_file_in_dbfs(dbfs_path, use_rest=False):
#     print("File exists using Spark.")
# else:
#     print("No file found using Spark.")
...
# SERVER_HOSTNAME = os.getenv("SERVER_HOSTNAME")
# ACCESS_TOKEN = os.getenv("ACCESS_TOKEN")
# FILESTORE_PATH = "dbfs:/mnt/transformed/Employee_Attrition_Data"  # Update this path as per your setup
# BASE_URL = f"https://{SERVER_HOSTNAME}/api/2.0"
